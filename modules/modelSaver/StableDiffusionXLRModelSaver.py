...
from modules.util.convert.convert_sdxlr_diffusers_to_ckpt import convert_sdxlr_diffusers_to_ckpt
from modules.util.enum.ModelFormat import ModelFormat
from modules.util.enum.ModelType import ModelType


class StableDiffusionXLRModelSaver(BaseModelSaver):
    ...
    def __save_ckpt(
        ...
        state_dict = convert_sdxlr_diffusers_to_ckpt(
            model_type,
    ...
    def __save_internal(
        ...
        # base model
        StableDiffusionXLRModelSaver.__save_diffusers(model, destination, torch.float32)
