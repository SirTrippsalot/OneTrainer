...
import torch
import yaml
from diffusers import AutoencoderKL, UNet2DConditionModel, DDIMScheduler, StableDiffusionXLImg2ImgPipeline
...
class StableDiffusionXLRModelLoader(BaseModelLoader):
    def __init__(self):
        super(StableDiffusionXLRModelLoader, self).__init__()

    @staticmethod
    def __default_yaml_name(model_type: ModelType) -> str | None:
        match model_type:
            case ModelType.STABLE_DIFFUSION_XLR_10:
                return "resources/diffusers_model_config/sd_xl_refiner.yaml"
            case _:
                return None
    ...
    def _create_default_model_spec(
        ...
        with open(StableDiffusionXLRModelLoader.__default_model_spec_name(model_type), "r") as model_spec_file:
    ...
    def __load_internal(
        ...
        # base model
        model = StableDiffusionXLRModelLoader.__load_diffusers(model_type, weight_dtypes, base_model_name)
        ...
        with open(StableDiffusionXLRModelLoader.__default_yaml_name(model_type), "r") as f:
        ...
        # model spec
        model.model_spec = StableDiffusionXLRModelLoader._create_default_model_spec(model_type)
        try:
    ...
    def __load_diffusers(
        ...
        model_spec = StableDiffusionXLRModelLoader._create_default_model_spec(model_type)

        return StableDiffusionXLRModel(
    ...
    def __load_ckpt(
        ...
        if not os.path.exists(yaml_name):
            ...
            if not os.path.exists(yaml_name):
                yaml_name = StableDiffusionXLRModelLoader.__default_yaml_name(model_type)
