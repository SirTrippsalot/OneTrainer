...
class MgdsStablDiffusionXLRBaseDataLoader(MgdsBaseDataLoader):
    def __init__(
            self,
            args: TrainArgs,
    ...
    def _load_input_modules(self, args: TrainArgs, model: StableDiffusionXLRModel) -> list:
    ...
    def _preparation_modules(self, args: TrainArgs, model: StableDiffusionXLRModel):
    ...
    def _output_modules(self, args: TrainArgs, model: StableDiffusionXLRModel):
        output_names = [
    ...
    def _debug_modules(self, args: TrainArgs, model: StableDiffusionXLRModel):
        ...
        decode_prompt = DecodeTokens(in_name='tokens_2', out_name='decoded_prompt', tokenizer=model.tokenizer_2)
