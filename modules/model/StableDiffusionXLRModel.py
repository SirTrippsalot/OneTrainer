...
class StableDiffusionXLRModelEmbedding:
    def __init__(
            self,
            name: str,
...
class StableDiffusionXLRModel(BaseModel):
    # base model data
    ...
    embeddings: list[StableDiffusionXLRModelEmbedding] | None
    ...
    def __init__(
        ...
        super(StableDiffusionXLRModel, self).__init__(
